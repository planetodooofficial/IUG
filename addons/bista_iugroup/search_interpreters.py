        ...
        if zip_code:
            ...
            if zips:
                ...
                if language_id and is_simultaneous:
                    ...
                    query = """select distinct(lang.interpreter_id) from interpreter_language as lang INNER JOIN res_partner as partner ON (lang.interpreter_id = partner.id)\
                ...
                for interpreter in res_partner_obj.browse(interpreter_ids):
                    ...
                    # if language_match:
                        ...
                        if language_id:
                             int_languages.append(language_id.name)
                        else:
                            language=''
                            for int_language_id in interpreter.language_lines:
                              language+=int_language_id.name.name
                              language+=','
                            int_languages.append(language[0:-1])
...
class select_interpreter_by_distance(models.Model):
    ...
    language_id=fields.Char('Language')
