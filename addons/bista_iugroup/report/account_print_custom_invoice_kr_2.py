...
#        tagline=model_id.company_id.partner_id.email or ''
    ...
    def print_fun(self,model_id):
        ...
        try:
            if model_id.number != 'False' or False:
                number=model_id.number
                res['number'] = number
            else:
                res['number'] = ''
        except Exception as e:
...
report_sxw.report_sxw(
    'report.account.invoice.custom_3',
    'account.invoice',
    'custom_addons/bista_iugroup/report/account_print_custom_invoice_kr_2.rml',
