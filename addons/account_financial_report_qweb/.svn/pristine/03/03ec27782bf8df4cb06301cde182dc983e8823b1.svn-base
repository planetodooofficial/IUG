    ...
    def _get_report_columns(self, report):
        if not report.show_move_line_details:
            return {
                ...
                1: {'header': _('Parent Customer'), 'field': 'parent_customer', 'width': 70},
                2: {'header': _('Total A/R'),
