...
class cancel_event_xls_parser(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(cancel_event_xls_parser, self).__init__(cr, uid, name, context=context)
        self.env = Environment(cr, uid, context)
        event_obj = self.env['event']
        self.context = context
        wanted_list = event_obj._report_xls_fields_kaiser_cancel()
...
class kaiser_cancel_event(report_xls):
    ...
    def __init__(self, name, table, rml=False, parser=False, header=True, store=False):
        super(kaiser_cancel_event, self).__init__(name, table, rml, parser, header, store)
        ...
        self.col_specs_template_kaiser_compliance = {
            'id': {
                'header': [1, 10, 'text', _render("_('Event ID')")],
                'lines': [1, 0, 'number', _render("line.id ")],
                'totals': [1, 0, 'text', None]},
            'date_service': {
                'header': [1, 10, 'text', _render("_('Date Service')")],
                'lines': [1, 0, 'text', _render("line.event_start_date or '' ")],
                'totals': [1, 0, 'text', None]},
            'language': {
                'header': [1, 13, 'text', _render("_('Language')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.language_id and line.language_id.name or '' "))],
                'totals': [1, 0, 'text', None]},
            'interpretation_type': {
                'header': [1, 20, 'text', _render("_('Interpretation Type')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.appointment_type_id and line.appointment_type_id.name or '' "))],
                'totals': [1, 0, 'text', None]},
            'interpreter': {
            ...
            'interpretation_city': {
                ...
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.location_id and line.location_id.city or '' "))],
                'totals': [1, 0, 'text', None]},
            'patient_name': {
                'header': [1, 15, 'text', _render("_('Patient Name')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.patient_id and line.patient_id.complete_name or '' "))],
                'totals': [1, 0, 'text', None]},
            'requester': {
                'header': [1, 20, 'text', _render("_('Requester')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.ordering_partner_id and line.ordering_partner_id.complete_name or '' "))],
                'totals': [1, 0, 'text', None]},
            'ordering_contact': {
                'header': [1, 20, 'text', _render("_('Ordering Contact')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.ordering_contact_id and line.ordering_contact_id.complete_name or '' "))],
                'totals': [1, 0, 'text', None]},
            'billing_customer': {
                'header': [1, 20, 'text', _render("_('Billing Customer')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.partner_id and line.partner_id.complete_name or '' "))],
                'totals': [1, 0, 'text', None]},
            'billing_customer_ref': {
                'header': [1, 13, 'text', _render("_('Billing Customer Ref')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.partner_id and line.partner_id.ref or '' "))],
                'totals': [1, 0, 'text', None]},
            'billing_contact': {
                'header': [1, 20, 'text', _render("_('Billing Contact')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.contact_id and line.contact_id.complete_name or '' "))],
                'totals': [1, 0, 'text', None]},
            'billing_contact_ref': {
                'header': [1, 13, 'text', _render("_('Billing Contact Ref')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.contact_id and line.contact_id.ref or ''"))],
                'totals': [1, 0, 'text', None]},
            'address': {
                'header': [1, 30, 'text', _render("_('Address')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.partner_id.street or '' "))],
                'totals': [1, 0, 'text', None]},
            'city': {
                'header': [1, 13, 'text', _render("_('City')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.partner_id.city or '' "))],
                'totals': [1, 0, 'text', None]},
            'zip': {
                'header': [1, 10, 'text', _render("_('Zip')")],
                'lines': [1, 0, 'text', _render("line.partner_id.zip or '' ")],
                'totals': [1, 0, 'text', None]},
            'location': {
                'header': [1, 25, 'text', _render("_('Location Services Provided')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.location_id and line.location_id.name or '' "))],
...
#                                                _render("line.invoice_id.event_id and line.invoice_id.event_id.location_id and line.invoice_id.event_id.location_id.street2 or '' "))],
            ...
            'street': {
                ...
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.location_id and line.location_id.street or '' "))],
                'totals': [1, 0, 'text', None]},
            'street2': {
                'header': [1, 25, 'text', _render("_('Street2')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.location_id and line.location_id.street2 or '' "))],
                'totals': [1, 0, 'text', None]},
            'start_time': {
            ...
            'po_no': {
                ...
                'lines': [1, 0, 'text', _render("line.po_no or ''")],
                'totals': [1, 0, 'text', None]},
            'medical_number': {
                'header': [1, 13, 'text', _render("_('MRN#')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.medical_no or ''"))],
                'totals': [1, 0, 'text', None]},
            'contract_no': {
            ...
            'event_purpose': {
                ...
                'lines': [1, 0, 'text', _render("str(line.event_purpose or '') or ''")],
                'totals': [1, 0, 'text', None]},
            'event_number': {
                'header': [1, 13, 'text', _render("_('Event Number')")],
                'lines': [1, 0, 'text', _render("str(line.name or '') or ''")],
                'totals': [1, 0, 'text', None]},
            'event_outcome': {
            ...
            'cancel_reason': {
                ...
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.cancel_reason_id and line.cancel_reason_id.name or ''"))],
                'totals': [1, 0, 'text', None]},
            'glcode': {
                'header': [1, 15, 'text', _render("_('GL String/NCOA code/Cost Center#')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.cust_gpuid or '' "))],
                'totals': [1, 0, 'text', None]},
            'nuid': {
                'header': [1, 15, 'text', _render("_('FDA NUID#')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.cust_csid or '' "))],
                'totals': [1, 0, 'text', None]},
            'requested_start_time': {
                'header': [1, 10, 'text', _render("_('Requested Start Time')")],
                'lines': [1, 0, 'text', _render("str(line.event_start_hr or '') + ':' + str(line.event_start_min or '') + ' ' + \
                                        str(line.am_pm or '') or '' #")],
                'totals': [1, 0, 'text', None]},
            
            'requested_end_time': {
                'header': [1, 10, 'text', _render("_('Requested End Time')")],
                'lines': [1, 0, 'text', _render("str(line.event_end_hr or '') + ':' + str(line.event_end_min or '') + ' ' + \
                                        str(line.am_pm2 or '') or '' #")],
                'totals': [1, 0, 'text', None]},
            'billed_duration': {
            ...
            'create_date': {
                ...
                'lines': [1, 0, 'text', _render("str(line.create_date or '') or ''")],
                'totals': [1, 0, 'text', None]},
            'less_than_24_notice': {
                'header': [1, 10, 'text', _render("_('< 24 notice')")],
                'lines': [1, 0, 'text', _render("str(line.intake_notice or '') or ''")],
                'totals': [1, 0, 'text', None]},
            ...
            'multi_type': {
                ...
                'lines': [1, 0, 'text', _render("'Two interpreters assigned for event' if line.multi_type and line.multi_type == '2' else '' ")],
                'totals': [1, 0, 'text', None]},
            'comments': {
            ...
            'department': {
                ...
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.department or '' "))],
                'totals': [1, 0, 'text', None]},
            'dr_name': {
                'header': [1, 15, 'text', _render("_('Doctor Name')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.dr_name or '' "))],
                'totals': [1, 0, 'text', None]},
            'patient_medical_number': {
                'header': [1, 13, 'text', _render("_('Patient Medical#')")],
                'lines': [1, 0, 'text', self.parse_unicode(_render("line.patient_id and line.patient_id.ssnid or ''"))],
                'totals': [1, 0, 'text', None]},
        }
...
kaiser_cancel_event('report.action.kaiser.cancel.event.xls', 'event',
    parser=cancel_event_xls_parser)
